    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        <div className="relative flex flex-col items-center">
          ...
          >
            <div className="group relative flex items-center gap-3 px-6 py-3 rounded-full bg-zinc-950 border border-zinc-800 hover:border-blue-500/50 transition-all duration-500 animate-core-pulse">
            ...
            {segments.map((seg, i) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-auto pt-6 flex items-center justify-end border-t border-white/5 opacity-50 group-hover:opacity-100 transition-opacity">
